...
**[Read the book online](https://g8row.github.io/durjaven/)** ·
**[raw PDF](https://g8row.github.io/durjaven/darzhaven-izpit-kn.pdf)** — the
first is a pdf.js reader with the book's outline in a sidebar; the second opens
in your browser's own PDF viewer, or downloads.
...
scrollbar. Zoom is `−` / `+` / `0` on the keyboard or in the toolbar, where
there is also a download button; `?file=` points the viewer at another PDF in
the repo.
